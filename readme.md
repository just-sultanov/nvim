...
My configuration for NeoVim based on [AstroNvim](https://astronvim.com/)
...
$ git clone git@github.com:just-sultanov/nvim.git ~/.config/nvim/lua/user
```

## License

[Copyright © 2023 Ilshat Sultanov](./license)
